                    ...
                    if (buildId) {
                        ...
                        return buildFactory.get(buildId).then(b =>
                            jobFactory.get(b.jobId).then(j => {
                                ...
                                if (b.parentBuilds) {
                                    restartConfig.parentBuildsInfo =
                                        b.parentBuilds;
                                }
                ...
                .then(
                    ({
                        ...
                        if (parentBuilds || parentBuildsInfo) {
                            payload.parentBuilds =
                                parentBuilds || parentBuildsInfo;
                        }
                        ...
                        if (
                            startFrom.match(
                                validationSchema.config.regex.PR_TRIGGER
                            ) &&
                            !prNum
                        ) {
                            throw boom.badRequest(
                                'Trigger "~pr" must be accompanied by a PR number'
                            );
                        }
                        ...
                        return Promise.all([
                            ...
                            .then(event => {
                                if (event.builds === null) {
                                    return reply(
                                        boom.notFound('No jobs to start.')
                                    );
                                }
