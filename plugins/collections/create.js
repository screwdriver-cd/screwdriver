                ...
                userFactory
                    ...
                    .then(user => {
                        ...
                        return collectionFactory
                            .get({ name: request.payload.name, userId: user.id })
                            .then(collection => {
                                if (collection) {
                                    throw boom.conflict(`Collection already exists with the ID: ${collection.id}`, {
                                        existingId: collection.id
                                    });
                                }

                                const config = { ...request.payload, userId: user.id };
