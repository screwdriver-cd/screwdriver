...
describe('event plugin test', () => {
    ...
    describe('POST /events', () => {
        ...
        beforeEach(() => {
            ...
            eventFactoryMock.get
                .withArgs(parentEventId)
                .resolves(getEventMock(testEvent));
        ...
        it(
            ...
            () => {
                ...
                return server.inject(options).then(reply => {
                    ...
                    assert.calledWith(
                        eventFactoryMock.scm.getCommitSha,
                        scmConfig
                    );
                    assert.notCalled(eventFactoryMock.scm.getPrInfo);
                });
        ...
        it(
            'returns 201 when it successfully creates a PR event when ' +
        ...
        it(
            'returns 201 when it successfully creates an event and updates admins ' +
        ...
        it(
            "returns 403 forbidden error when user's scm" +
    ...
    describe('PUT /events/{id}/stop', () => {
        ...
        it(
            'returns 200 and stops all event builds when user has push permission' +
        ...
        it(
            ...
            () => {
                const error = {
                    ...
                    error: 'Forbidden',
                    message:
                        'User myself does not have push permission for this repo'
                };
