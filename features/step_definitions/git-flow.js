...
Given(
    ...
    function step() {
        ...
        return Promise.all(builds).catch(() =>
            Assert.fail('failed to clean up builds')
        );
    }
);
...
When(
    ...
    function step() {
        return sdapi
            ...
            .then(() =>
                github.createFile(this.branch, this.repoOrg, this.repoName)
            )
            .then(({ data }) => {
...
When(
    ...
    function step() {
        ...
        return github
            .createFile(this.testBranch, this.repoOrg, this.repoName)
            .then(({ data }) => {
                this.sha = data.commit.sha;
            });
    }
    ...
    function step() {
        ...
        return github
            ...
            .then(({ data }) => {
                ...
                return github.createAnnotatedTag(
                    tag,
                    branch,
                    this.repoOrg,
                    this.repoName
...
Then(
    ...
    function step() {
        return github
            .getStatus(this.repoOrg, this.repoName, this.sha)
            .then(({ data }) => {
